  ...
  return (
    ...
    >
      <div className="w-full h-full backdrop-brightness-50">
        <div className="container mx-auto my-50 w-full flex gap-x-2 justify-center md:justify-between items-center">
          <div className="mx-8 md:w-1/2">
            ...
            <p className="text-xs md:text-base font-semibold leading-7">
              ...
              <button onClick={() => navigate(`/movieDetails/${movie.id}`)} className="px-6 py-1 rounded-3xl bg-red-600 shadow-lg shadow-red-500/50 my-6 cursor-pointer text-xl font-lg font-semibold hover:brightness-75">
                Watch Now
              </button>
          </div>
          <div className="rounded-3xl overflow-hidden shadow-2xl/70 hidden md:block md:w-sm ">
